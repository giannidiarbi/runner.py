...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 24 15:52:34 2023
...
class Runner:
    ''' class: Runner
        ...
        attributes: runner name
                    distance runner ran each day in Feb
                    x-position on matplotlib grid
                    y-position on matplotlib grid
                    color on matplotlib grid
    ...
    def draw(self):
        plt.plot(self.x, self.y, self.color, marker = ">", markersize = 8,
                 label = self.name)
